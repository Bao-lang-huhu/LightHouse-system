...
const AddMaintenance = () => {
  ...
  const [maintenanceNotes, setMaintenanceNotes] = useState(''); // State for housekeeping notes
  const [maintenanceType] = useState('Request'); // Hardcoded housekeeping type
  ...
  const handleSaveChanges = () => {
    ...
    if (selectedRoom && !savedRooms.some(r => r.id === selectedRoom.id)) {
      ...
      setMaintenanceNotes(''); // Clear notes
    }
  };
      ...
      <div className='columns'>
          ...
          <div style={{ backgroundColor: 'white', borderRadius: '10px', height: '100%', display: 'flex', flexDirection: 'column' }}>
            <div style={{ flex: 1 }}>
              ...
              <p className='has-text-grey' style={{ marginTop: '25px', marginLeft: '18px', fontSize: '16px', margin: 10 }}>
                Available rooms for maintenance
              </p>
        ...
        <div className='column is-9'>
          {selectedRoom ? ( // Check if a room is selected
              ...
              <div className='columns'>
                <div className='column is-6'>
                  <div className='field'>
                    ...
                    <div className='control'>
                      <input className='input' type='text' value={maintenanceType} readOnly />
                    </div>
                  </div>
                  <div className='field'>
                ...
                <div className='column is-6'>
                  <div className='field'>
                    <label className='label'>Room Requiring Maintenance</label>
                    <div className='control'>
            ...
            <div className='box'>
              <p>Please select a room to mark as unmaintained.</p>
            </div>
          )}
        </div>
      </div>
        ...
        <div className='column is-9'>
          <div className='box'>
            <div className='columns'>
              ...
              <div className='column is-6'>
                <div className='field'>
                  <label className='label'>Room to Maintain</label>
                  <div className='control'>
              ...
              <div className='field'>
                  <label className='label'>Maintenance Staff Name</label>
                  <div className='control'>
                    <input
                      className='input'
                      type='text'
            ...
            {/* Modal Component */}
            <AllMaintenanceRecordsModal isVisible={isModalVisible} onClose={toggleModal} />
          </div>
        </div>
      </div>
    </section>
