...
const AddMaintenance = () => {
    ...
    const fetchMaintenanceRooms = async () => {
        try {
            const response = await axios.get('http://localhost:3001/api/maintenance-rooms');
    ...
    const handleSaveChanges = async () => {
        ...
        try {
            const response = await axios.post('http://localhost:3001/api/add-maintenance', {
                maintenanceType,
                maintenanceName,
                maintenanceNotes,
                roomNumber,
    ...
    const handleMaintenanceRoomClick = async (room) => {
        ...
        try {
            const response = await axios.get(`http://localhost:3001/api/maintenance/${room.maintenance_id}`);
    ...
    const handleMarkAsCompleted = async () => {
        ...
        try {
            await axios.put(`http://localhost:3001/api/maintenance/${selectedMaintenance.maintenance_id}/completed`, {
    ...
    const handleCancelMaintenance = async () => {
        ...
        try {
            await axios.put(`http://localhost:3001/api/maintenance/${selectedMaintenance.maintenance_id}/cancel`, {
