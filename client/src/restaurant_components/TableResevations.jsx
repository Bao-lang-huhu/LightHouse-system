...
const TablReservations = () => {
  ...
  const fetchTables = async () => {
    try {
      const response = await axios.get('https://light-house-system-h74t-server.vercel.app/api/getTables');
  ...
  const fetchReservations = async () => {
    setLoading(true);
    try {
      const response = await axios.get('https://light-house-system-h74t-server.vercel.app/api/getTableReservations', {
    ...
    if (selectedGuest) {
      ...
      try {
        const response = await axios.put(
          `https://light-house-system-h74t-server.vercel.app/api/updateTableReservationStatus/${selectedGuest.table_reservation_id}`,
          {
