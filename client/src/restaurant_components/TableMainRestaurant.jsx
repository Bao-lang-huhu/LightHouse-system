...
const TableMainRestaurant = () => {
  ...
  useEffect(() => {
    const fetchTables = async () => {
      try {
        const response = await axios.get('https://light-house-system-h74t-server.vercel.app/api/getTables'); // Replace with your API endpoint
  ...
  const handleSaveChanges = async () => {
    try {
      ...
      const response = await axios.put(`https://light-house-system-h74t-server.vercel.app/api/updateTable/${selectedTable.table_id}`, selectedTable);
